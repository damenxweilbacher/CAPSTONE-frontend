...
function About() {
  return (
    <div className="container">
      ...
      <div className="card">
        <p>
          This app was built to help people who don't know certain issues with their cars how to diagnose simple vehicle issues. With the 4 categories, you are prompted a quiz. Your answers are then examined and a diagnosis will be given out according to your answers.
        </p>
      </div>
      ...
      <div className="card">
        ...
        <br />
          <p> Damen Weilbacher </p>
          <p> Junior Software Engineer / Technician </p>
            <p> "LinkedIn": 
